                    ...
                    <div className="features-cards-wrapper">
                        ...
                        <div className="home-integrations-wrapper">
                            <div className="integrations-content-component">
                                <div data-w-id="87eb6bc4-11f4-c138-41ab-f278fcfa9472" className="integrations-block first">
                                ...
                                <div data-w-id="87eb6bc4-11f4-c138-41ab-f278fcfa947c" className="integrations-block second">
                                    <div className="integrations-image">
                                        <img
                            ...
                            <div className="integrations-content-component">
                                <div data-w-id="87eb6bc4-11f4-c138-41ab-f278fcfa9487" className="integrations-block second">
                                    <div className="integrations-image">
                                        <img loading="lazy"
                                ...
                                <div data-w-id="87eb6bc4-11f4-c138-41ab-f278fcfa9491" className="integrations-block first">
                                    <div className="integrations-image">
                        ...
                        <div data-w-id="8987cab3-f15e-de6f-2dab-834f91d30665" className="double-button-component">
                            <GetStarted />
                            <LearnMoreButton />
                        </div>
                    </div>
