      ...
      <div className="padding-global">
        <div className="w-layout-blockcontainer container w-container">
          <div className="max-w-4xl mx-auto">
            ...
            {/* URL Input */}
            <div className="mb-8 p-6 border border-[#17171A]/10 rounded-lg bg-white">
              ...
              <input
                ...
                className="w-full p-3 border border-[#17171A]/15 rounded-lg bg-white text-[#17171A] placeholder-gray-500"
                required
              />
            ...
            <div className="mb-8 p-6 border border-[#17171A]/10 rounded-lg bg-white">
              ...
              <div className="mb-6">
                ...
                <input
                  ...
                  className="w-full p-3 border border-[#17171A]/15 rounded-lg bg-white text-[#17171A] placeholder-gray-500 mb-2"
                  required
                />
                <div className="flex flex-wrap gap-2">
                  {presets.sources.map(source => (
                    <button
                      ...
                      className="px-3 py-1 text-size-small border border-[#17171A]/25 rounded hover:bg-[#17171A]/10"
                    >
                      {source}
                    </button>
                  ))}
            ...
            {generatedUrl && (
              <div className="p-6 border border-green-500/30 rounded-lg bg-green-500/10">
                ...
                <div className="p-3 bg-[#17171A]/5 rounded mb-4 break-all font-mono text-size-small">
                  {generatedUrl}
                </div>
                <div className="flex flex-col sm:flex-row gap-3">
                  <button
                    onClick={copyToClipboard}
                    className="px-4 py-2 border border-[#17171A]/25 rounded hover:bg-[#17171A]/10"
                  >
                  ...
                  <a
                    ...
                    className="px-4 py-2 border border-[#17171A]/25 rounded hover:bg-[#17171A]/10 text-center"
                  >
                    Test URL →
                  </a>
                </div>
            ...
            {/* Best Practices */}
            <div className="mt-12 p-6 border border-[#17171A]/10 rounded-lg bg-white">
            ...
            {/* Common Use Cases */}
            <div className="mt-8 p-6 border border-[#17171A]/10 rounded-lg bg-white">
              <h3 className="text-size-large text-weight-medium mb-4">
                Common Use Cases
              </h3>
              <div className="grid md:grid-cols-2 gap-4 text-size-small">
                <div>
                  ...
                  <code className="block p-2 bg-[#17171A]/5 rounded text-xs">
