      ...
      <div className="padding-global">
        <div className="w-layout-blockcontainer container w-container">
          <div className="max-w-4xl mx-auto">
            ...
            {/* URL Input */}
            <div className="mb-8 p-6 border border-gray-200 rounded-lg bg-[#F7F7F5]">
            ...
            <div className="mb-8 p-6 border border-gray-200 rounded-lg bg-[#F7F7F5]">
              ...
              <div className="mb-6">
                ...
                <input
                  ...
                  className="w-full p-3 border border-gray-300 rounded-lg bg-white text-gray-900 placeholder-gray-500 mb-2"
                  required
                />
                <div className="flex flex-wrap gap-2">
                  {presets.sources.map(source => (
                    <button
                      ...
                      className="px-3 py-1 text-size-small border border-gray-400 rounded hover:bg-gray-200"
                    >
                      {source}
                    </button>
                  ))}
            ...
            {generatedUrl && (
              <div className="p-6 border border-green-500/30 rounded-lg bg-green-500/10">
                ...
                <div className="p-3 bg-gray-100 rounded mb-4 break-all font-mono text-size-small">
                  {generatedUrl}
                </div>
                <div className="flex flex-col sm:flex-row gap-3">
                  ...
                  <a
                    ...
                    className="px-4 py-2 border border-gray-400 rounded hover:bg-gray-200 text-center"
                  >
                    Test URL →
                  </a>
                </div>
            ...
            {/* Best Practices */}
            <div className="mt-12 p-6 border border-gray-200 rounded-lg bg-[#F7F7F5]">
            ...
            {/* Common Use Cases */}
            <div className="mt-8 p-6 border border-gray-200 rounded-lg bg-[#F7F7F5]">
              <h3 className="text-size-large text-weight-medium mb-4">
                Common Use Cases
              </h3>
