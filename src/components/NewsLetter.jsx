                ...
                {status === FORM_STATUS.IDLE && (
                    <form className="w-full grid gap-4 grid-cols-[1fr_max-content]" onSubmit={handleSubmit}>
                        ...
                        <div className="relative">
                            <input
                                type="submit"
                                className="appearance-none w-full leading-normal outline-none border-none cursor-pointer rounded-lg p-4 font-semibold text-lg bg-white bg-opacity-10 text-neutral-900 z-10 opacity-100"
                                value="Sign Up"
                            />
                        </div>
                    </form>
