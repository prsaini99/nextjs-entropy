                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 w-full">
                            {caseStudies.map((cs, index) => (
                                <AnimatedInViewDiv
                                    key={cs.brand}
                                    delay={index * 0.08}
                                    className="border border-[#17171A]/10 rounded-lg p-8 bg-white hover:border-[#E0362C]/60 transition-colors duration-300 flex flex-col gap-4"
                                >
                                    ...
                                    <div className="grid grid-cols-3 gap-3 mt-auto pt-4 border-t border-[#17171A]/10">
