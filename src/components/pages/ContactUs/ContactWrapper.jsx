                ...
                <div className="w-layout-blockcontainer container w-container">
                    <div className="contact-wrapper">
                        ...
                        <AnimatedInViewDiv className="flex flex-col sm:flex-row gap-4 items-center justify-center my-8" delay={0.2}>
                            <a
                                href="https://calendly.com/stackbinary/30min"
                                target="_blank"
                                rel="noopener noreferrer"
                        ...
                        <AnimatedInViewDiv className="contact-info-section" delay={0.15}>
                            <div className="text-center mb-8">
                                ...
                                {/* Office Locations. The Dubai office block deliberately does
                                    NOT appear here: the owner wants Dubai contact details shown
                                    only in the Dubai context (DubaiOfficeStrip on /services/
