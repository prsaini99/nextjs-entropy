                    ...
                    <div className="team-wrapper">
                        ...
                        <div className="team-grid">
                            {teamMembers.map((member, index) => (
                                <AnimatedInViewDiv delay={index * .2} key={member.name} className="children-perspective">
                                    <div className="team-card">
                                        <div className="team-image"><img src={member.image} alt="Team Images" loading="lazy" /></div>
